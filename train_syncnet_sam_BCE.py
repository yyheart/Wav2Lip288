    ...
    while global_epoch < nepochs:
        ...
        try:
            ...
            for step, data in tqdm(enumerate(train_data_loader)):
                ...
                sync_score = sync_score.cuda() # B 1 8 8
                ...
                # print(sync_score[0])
                """
                    tensor([[[[0.5180, 0.4710, 0.3636, 0.3529, 0.3153, 0.3258, 0.2677, 0.3044],
                            [0.4837, 0.4654, 0.3721, 0.3343, 0.2918, 0.3437, 0.3088, 0.3458],
                            [0.4511, 0.4547, 0.4082, 0.3369, 0.2406, 0.1673, 0.0901, 0.1685],
                            [0.3192, 0.2806, 0.2374, 0.1844, 0.1498, 0.1878, 0.1086, 0.1559],
                            [0.3657, 0.3425, 0.2878, 0.2222, 0.2152, 0.2185, 0.1189, 0.1305],
                            [0.3599, 0.3599, 0.3051, 0.2748, 0.2548, 0.3080, 0.1606, 0.2056],
                            [0.4513, 0.3925, 0.2889, 0.1878, 0.1900, 0.2327, 0.1956, 0.2374],
                            [0.5347, 0.4568, 0.3330, 0.2657, 0.2687, 0.3156, 0.3227, 0.3976]]]],
                """
                # should be  ([B, 1, 8, 8])
