...
class DataProcessingOptions:
    ...
    def parse_args(self):
        ...
        self.parser.add_argument(
            "--source_video_dir",
            type=str,
            default="/mnt/hd/DINet_optimized/asserts/training_data_mead/split_video_25fps_mead",
            help="path of source video in 25 fps",
        )
        self.parser.add_argument(
            "--openface_landmark_dir",
            type=str,
            default="/mnt/hd/DINet_optimized/asserts/training_data_mead/split_video_25fps_landmark_openface_mead",
            help="path of openface landmark dir",
        )
        self.parser.add_argument(
            "--video_frame_dir",
            type=str,
            default="/mnt/hd/DINet_optimized/asserts/training_data_mead/split_video_25fps_frame_mead",
            help="path of video frames",
        )
        self.parser.add_argument(
            "--audio_dir",
            type=str,
            default="/mnt/hd/DINet_optimized/asserts/training_data_mead/split_video_25fps_audio_mead",
            help="path of audios",
        )
        self.parser.add_argument(
            "--deep_speech_dir",
            type=str,
            default="/mnt/sdb/cxh/data/training_data_HDTF5/split_video_25fps_deepspeech",
            help="path of deep speech",
        )
        self.parser.add_argument(
            "--crop_face_dir",
            type=str,
            default="/mnt/sdb/cxh/data/training_data_HDTF5/split_video_25fps_crop_face",
            help="path of crop face dir",
        )
        self.parser.add_argument(
            "--json_path",
            type=str,
            default="/mnt/sdb/cxh/liwen/wav2lip_288x288/config/training_json.json",
...
class DINetTrainingOptions:
    ...
    def parse_args(self):
        ...
        self.parser.add_argument(
            "--train_data",
            type=str,
            default=r"/mnt/sdb/cxh/liwen/wav2lip_288x288/config/training_json.json",
            help="path of training json",
        )
